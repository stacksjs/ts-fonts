// CFF predefined SID table (391 strings). SIDs 0–390 map to these entries;
// SIDs ≥ 391 index into the font's string INDEX as (sid - 391).
export const CFF_STANDARD_STRINGS: string[] = [
...
export function getCFFString(fontStrings: string[], sid: number): string | undefined {
  if (sid < 391)
    return CFF_STANDARD_STRINGS[sid]
  return fontStrings[sid - 391]
}
